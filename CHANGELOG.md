...
- fix desired configuration for `react-hooks/exhaustive-deps`

## 14.0.0 - 2021-12-15

- add eslint-plugin-react-hooks to configuration

## 13.0.0 - 2021-12-06

- update eslint-config-airbnb and peer dependencies
  - eslint-config-airbnb from 18.2.1 to 19.0.2
